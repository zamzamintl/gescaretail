...
{
    'name': 'O4F Print Product Labels',
    'version': '12.0.0.1.0',
    'category': 'Misc',
    'summary': 'Document with product labels',
    'description': 'Create a document with product labels',
    'author': 'Accomodata',
    ...
    'data': [
        'report/assets.xml',
        'report/blank_external_layout.xml',
        'report/labels_sheet.xml',
        'views/print_product_labels.xml',
