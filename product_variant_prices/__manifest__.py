...
{
    'name': 'Product Variant Prices',
    'version': '12.0.0.0.9',
    'category': 'product',
    'summary': 'Manage sales & purchase prices for all variants at once',
    'description': 'Manage sales & purchase prices for all variants at once',
    'author': 'Accomodata',
    ...
    'data': [
        'wizards/wizard_product_prices.xml',
